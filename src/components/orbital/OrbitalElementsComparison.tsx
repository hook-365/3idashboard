    ...
    <div className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 backdrop-blur-sm rounded-2xl border border-gray-700/50 p-6">
        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-gray-700/50">
              <th className="text-left py-3 px-4 text-sm font-semibold text-gray-400">Element</th>
              <th className="text-right py-3 px-4 text-sm font-semibold text-gray-400">MPC Value</th>
              <th className="text-right py-3 px-4 text-sm font-semibold text-gray-400">JPL Value</th>
              <th className="text-right py-3 px-4 text-sm font-semibold text-gray-400">Δ Difference</th>
      ...
      {validation.summary.total_elements > 0 && (
        <div className="mt-6 grid grid-cols-4 gap-4">
          ...
          <div className="bg-gray-800/30 rounded-lg p-3 text-center">
            ...
            <div className="text-xs text-gray-500">Agreeing</div>
          </div>
          <div className="bg-gray-800/30 rounded-lg p-3 text-center">
            <div className="text-lg font-bold text-yellow-400">{validation.summary.disagreeing_elements}</div>
            <div className="text-xs text-gray-500">Disagreeing</div>
          </div>
          <div className="bg-gray-800/30 rounded-lg p-3 text-center">
            <div className="text-lg font-bold text-gray-400">{validation.summary.missing_elements}</div>
      ...
      {metadata.length > 0 && (
        <div className="mt-6 pt-6 border-t border-gray-700/50">
          <h4 className="text-sm font-semibold text-gray-400 mb-3">Data Source Metadata</h4>
      ...
      <div className="mt-6 pt-6 border-t border-gray-700/50">
        <details className="group">
          ...
          <div className="mt-3 text-xs text-gray-500 space-y-1 ml-6">
      ...
      {/* Data Attribution */}
      <div className="mt-6 pt-6 border-t border-gray-700/50 text-xs text-gray-500 text-center">
        <p>
          MPC data from{' '}
          <a
